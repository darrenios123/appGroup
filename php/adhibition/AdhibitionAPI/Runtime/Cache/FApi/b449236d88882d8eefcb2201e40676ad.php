	...
	<div class="container">
		...
		<table class="table table-bordered table-striped table-hover">
			...
			<?php if(is_array($data)): foreach($data as $key=>$res): ?><tr>
				<td><?php echo ($res['ios_data']['time']); ?></td>
				<td><?php echo ($res['ip']); ?></td>
				<td><?php echo ($res['ios_data']['times']); ?></td>
				<td><?php echo ($res['ios_data']['language']); ?></td>
				<td><?php echo ($res['ios_data']['aname']); ?></td>
				<td><?php echo ($res['ios_data']['app_name']['app_name']); ?></td>
				<td><?php echo ($res['ios_data']['return_url']); ?></td>
